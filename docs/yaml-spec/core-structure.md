...
A nested child is not required to have an `id`. Full and compact serialization preserve one when
present; a hand-authored minimal artifact normally has no repository-assigned IDs yet.
