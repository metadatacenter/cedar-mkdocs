...
| [Docker for evaluation](../install-docker-eval/overview/)        | Installed onto a user machine, for evaluation purposes. The domain name is fixed, some configuration options can be changed. |
