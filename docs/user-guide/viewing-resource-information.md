...
OpenView is a CEDAR feature that allows you to publish CEDAR artifacts to the web, where anyone with the IRI can view them. [OpenView](openview.md) describes publishing a resource, how to reach a published page, what a reader sees there, and what stays hidden.
